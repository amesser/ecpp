...
void Reset_Handler(void) __attribute__ ((weak, alias("DefaultReset_Handler")));
void Dummy_Handler(void) __attribute__ ((weak, alias("DefaultDummy_Handler")));
void Fault_Handler(void) __attribute__ ((weak, alias("DefaultFault_Handler")));
...
const DeviceVectors exception_table __attribute__ ((section(".vectors"))) =
{
